...
export default function Footer() {
  ...
  return (
    <div className="relative w-full bg-[#F5F2EB]">
      ...
      <motion.section 
        ref={sectionRef} 
        className="relative w-full bg-[#fbe555] flex flex-col items-center justify-between overflow-hidden z-20 text-[#111]"
      ...
      >
        ...
        <div className="relative w-full max-w-[88vw] xl:max-w-[1350px] mx-auto border-x border-[#111]/20 flex flex-col pt-24 lg:pt-32">
          
          {/* Massive Background Text & Pixel Art */}
          <div className="relative w-full flex flex-col items-center justify-center pointer-events-none select-none z-0">
            {/* Background Text */}
            <h1 
          ...
          {/* Bottom Section */}
          <div className="relative w-full border-t border-[#111]/20 px-6 md:px-12 lg:px-20 py-12 md:py-16 mt-24 lg:mt-32 z-10">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-end w-full max-w-[88vw] xl:max-w-[1350px] mx-auto px-0 lg:px-0">
              ...
              <div className="flex flex-col items-start md:items-end gap-6 mb-2">
                ...
                <div className="flex items-center gap-4">
                  <a href="#" className="p-3.5 border border-[#111] rounded-full hover:bg-[#111] hover:text-[#fdf03e] transition-colors duration-300">
            ...
            {/* Credits Row */}
            <div className="flex flex-col md:flex-row justify-between items-center w-full max-w-[88vw] xl:max-w-[1350px] mx-auto mt-16 pt-8 border-t border-[#111]/10 text-xs md:text-sm font-medium text-[#111]/70">
              <p>Designed in <strong className="text-[#111]">Figma</strong></p>
              <p>Created with <strong className="text-[#111]">Claude Code</strong></p>
            </div>
          </div>
