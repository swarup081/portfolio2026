        ...
        >
          ...
          <div className="flex-1 p-8 md:p-12 flex flex-col">
            ...
            <div className="flex flex-col gap-5 w-fit relative z-10" style={{ fontFamily: "'Aeonik TRIAL', sans-serif" }}>
              {["Home", "Work", "Stories", "About", "Contact"].map((item, i) => (
                <motion.div
                  key={item}
          ...
          <div className="w-full md:w-[340px] bg-white/[0.03] p-8 md:p-12 flex flex-col relative border-t md:border-t-0 md:border-l border-white/10">
            ...
            <motion.a 
              href="mailto:dasswarup.work@gmail.com"
              initial={{ opacity: 0, y: 10 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.5, delay: 0.4 }}
              onClick={(e) => e.stopPropagation()}
              className="px-6 py-3 w-full rounded-full text-white text-xs font-semibold tracking-[0.2em] uppercase border border-white/20 hover:bg-[#FFE45E] hover:text-[#151515] hover:border-[#FFE45E] transition-all duration-300 block text-center"
